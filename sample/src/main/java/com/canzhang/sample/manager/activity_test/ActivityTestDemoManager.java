...
public class ActivityTestDemoManager extends BaseManager {
     ...
     * @return
     */
    private ComponentItem startOtherAppActivity() {
        return new ComponentItem("启动别的app的activity", "1、android:exported=\"true\"" +
                "\n2、intent.setClassName(\"packageName\",\"全类名\")", new View.OnClickListener() {
            @Override
