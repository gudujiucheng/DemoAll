package com.canzhang.sample.manager.log.reader;

import android.text.TextUtils;

import com.canzhang.sample.manager.log.helper.LogcatHelper;
import com.canzhang.sample.manager.log.helper.RuntimeHelper;
