 ...
 * <p>
 * 需要注意的是设置的indicator_icon 需要是个selector(参见范例如下)
 * <item android:state_selected="true" android:drawable="@mipmap/ic_common_checkbox_press"/>
 * <item android:state_selected="false" android:drawable="@mipmap/ic_common_checkbox_normal"/>
 * Created by zc on 2017/3/7.
 */
...
public class ViewPagerIndicator extends View implements ViewPager.OnPageChangeListener {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mCount; i++) {//画出所有的固定点
            /*
             * 这里也需要解释一下，
